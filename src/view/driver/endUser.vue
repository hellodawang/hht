            ...
            <el-col :span='18' >
                <div class="section history" >
                    <el-collapse accordion v-model="activeNames" >
                        <el-collapse-item :title="downloadHistory" name="first">
                             <div class="section-content" >
                                <div v-if="downloadHistory=='历史纪录'" class="clearfix">
                                    ...
                                    <div class="arrow">
                                        <i class="icon iconfont icon-jiantou1" @click="goAppStore"></i><p>进入应用商城</p>
                                    </div> 
                                </div>
                                <div v-if="downloadHistory=='应用商城'" class="clearfix">
                                    ...
                                    <div class="arrow"><i class="icon el-icon-back" @click="goAppHistory"></i><p>返回历史记录</p></div>
                                </div>
                                <!-- <el-row  >
                                    <el-col :span="20">
                                        <div class="downloadApp-wrapper">
                ...
                <div class="section" style="height:92%; min-height:500px;overflow-y:scroll;background-color:#fff">
                    <my-zone></my-zone>                    
                </div>
            </el-col>

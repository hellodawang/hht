					...
					<el-col :span="17">
						<div class="deviceInfo-list">
							...
							<el-table ref="multipleTable" :data="tableData" @selection-change="handleSelectionChange" tooltip-effect="dark"
								...
								<el-table-column prop="location" label="所在地" width="70" show-overflow-tooltip></el-table-column>
								<el-table-column prop="lastUpgradeDate" label="上次更新时间" width="110" show-overflow-tooltip></el-table-column>

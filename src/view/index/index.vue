    ...
    <div class="hht_wrapper">
				...
				<div class="hht_user">
					<el-popover
						...
						<div class="user-operate">
							<div class="personal-settings" @click="setting = true">个人设置</div>
					...
					<div class="hht_user_text">
						...
						<div class="hht_user_role">{{userRole}}</div>
					</div>
				</div>
        ...
        <div class="hht_content">
            <div class="hht_content_header">
				<el-row>
					<el-col :span="8"><div style="height:52px;width:20px"><i class="iconfont icon-menu" @click="toggle" v-if="!userData.role.match('user')"></i></div></el-col>
					<el-col :span="8">
					...
					<el-col :span="8">
						<div class="menubar">
							...
							<div class="language">
								<el-select v-model="languageValue" placeholder="请选择" @change="languageChange">
									<el-option
		...
		<el-dialog title="个人设置" :visible.sync="setting" @dialogChange='dialogChange' class="hht-dialog" center>
			<div class="dialog-content">
				<el-form  class="model-form"  label-width="200px" :model="user" >
					...
					<el-form-item  >
						<el-button type="primary" class="submit-btn" @click="confirm" size="mini">确定</el-button>  
					</el-form-item>                       
				</el-form>
			</div>
	...
	computed:{
		showSideBar(){
			if(sessionStorage.getItem('showSideBar')){
				let flag = JSON.parse(sessionStorage.getItem('showSideBar'))				

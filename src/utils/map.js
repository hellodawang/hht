...
echarts.extendsMap = function(dom, opt, mapData) {
    ...
    var option = {
            ...
            },
            {
                ...
                children: [{
                    ...
                    onclick: function() {
                        ...
                        option.visualMap.max = data ? data.reduce((a, v) => a > parseInt(v.value) ? a : parseInt(v.value), 10) : 100
        ...
        visualMap: {
            min: 0,
            max: mapData.china ? (mapData.china.reduce((a, v) => a > parseInt(v.value) ? a : parseInt(v.value), 10))*1.2 : 100,
            left: 'right',
            top: 'bottom',
            text: ['High', 'Low'],
            seriesIndex: [0],
